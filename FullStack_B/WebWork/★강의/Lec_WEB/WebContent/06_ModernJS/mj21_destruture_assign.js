...
// 위와 같이
// 분해할 값이 없을대 기본값을 적용하려면?

// 1. SCE
print = function({a, b}){
    b = b || 2   // b의 기본값은 2
    console.log(`print(a=${a}, b=${b}) 호출 (b 기본값 2)`)
}
print({a : 22})

// 2. default parameter 사용  (제대로 된 방법!)
print = function({a, b = 2}){
    console.log(`print(a=${a}, b=${b}) 호출 (default param)`)
}
print({a : 33})

// default parameter 는 함수에서만 사용할수 있는 것은 아니다.
console.log()
let {c, d = 30} = {c: 111, e: 222}
console.log(`c = ${c}, d = ${d}`)
