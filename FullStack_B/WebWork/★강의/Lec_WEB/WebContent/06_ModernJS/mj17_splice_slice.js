...
numbers.splice(2, 1)  // 배열인덱스 2 부터 1개를 제거
console.log('numbers =', numbers)  // ★ 원본 numbers 가 변화되었다.
...
console.log();
numbers = [10, 20, 30, 40];
let sliced = numbers.slice(1, 3)  // 인덱스 1 부터 3 전까지
console.log('sliced =', sliced)  // [ 20, 30 ]
console.log('number =', numbers) // ★ 원본데이터 변화 없다!
