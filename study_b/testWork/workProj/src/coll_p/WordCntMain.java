...
//		System.out.println(Arrays.toString(arr));
		...
		HashMap map = new HashMap(); // 정렬을 위해 TreeMap 사용

//		for (String string : arr) {
//			map.put(string, string);
//		}
		for (String string : news.split(" ")) {
...
//		System.out.println(entery);
		...
		// count 를 세기 위한 map 생성

//		Map yaksu = new HashMap(); // 정렬을 위하여 TreeMap 사용
		Map yaksu = new TreeMap(); // 정렬기준은 key
...
//					int count = 0;
					...
					if (yaksu.containsKey(j))
						count += (int) yaksu.get(j); // 현재 value 가 없을시 0 있을시 value의 값을 count 더해줌
//						count++;

					System.out.println(count);

					yaksu.put(j, count); // 갑의 교체
...
//		Set enYaksu = yaksu.entrySet();
//
//		for (Object obj : enYaksu) {
//
//			Map.Entry enYaksu2 = (Map.Entry) obj;
//
//			System.out.println(enYaksu2.getKey() + " : " + enYaksu2.getValue());
//
//		}
