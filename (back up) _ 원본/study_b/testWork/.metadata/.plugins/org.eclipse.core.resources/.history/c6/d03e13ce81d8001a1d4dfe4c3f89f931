...
public class ObjExamOut {
	...
	public static void main(String[] args) {
		try {
			...
			arr.add(new ObjExam("»´º∫«ı", 77,78,72));
			arr.add(new ObjExam("¿Ã¡÷«ı", 67,68,62));
			arr.add(new ObjExam("±Ëø¨º∑", 97,98,92));
			arr.add(new ObjExam("±Ë«ˆ¡ÿ", 57,58,52));
			arr.add(new ObjExam("¿Â¡§»£", 67,78,92));
			arr.add(new ObjExam("¿Ã»£¿Œ", 97,86,32));
