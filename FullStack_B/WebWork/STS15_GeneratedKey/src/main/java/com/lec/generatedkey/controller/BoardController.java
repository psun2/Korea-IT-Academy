...
import com.lec.generatedkey.service.JdbcTemplateBoardServiceImpl;
...
public class BoardController {
    ...
    @Autowired
    @Qualifier("myBatisBoardServiceImpl")
    private BoardService boardService;

    @Autowired
    private JdbcTemplateBoardServiceImpl jdbcTemplateBoardServics;
    ...
    public void writeOk(Model model, BoardDTO dto) {
        jdbcTemplateBoardServics.write(dto);
