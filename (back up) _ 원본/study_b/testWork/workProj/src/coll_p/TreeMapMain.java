...
public class TreeMapMain {
	...
	public static void main(String[] args) {
		TreeClothes [] tcArr = {
				...
				new TreeClothes("in", "나이키", "헬스복", 90),
				new TreeClothes("out", "아디다스", "등산복", 100),
				new TreeClothes("in", "필라", "헬스복", 190),
				new TreeClothes("out", "아디다스", "런닝복", 100),
				new TreeClothes("inner", "나이키", "헬스복", 90),
				new TreeClothes("in", "필라", "헬스복", 100),
				new TreeClothes("out", "나이키", "런닝복", 100),
				new TreeClothes("in", "나이키", "등산복", 90),
				new TreeClothes("out", "아디다스", "등산복", 105),
				new TreeClothes("out", "나이키", "헬스복", 90),
