...
public class InheriStudMain {
	...
	public static void main(String[] args) {
		GenStud [] gsArr = {
				new GenStud("일호아웃",49,43,42),
                new GenStud("이호아웃",97,93,92),
                new GenStud("삼호아웃",77,73,72),
                new GenStud("사호아웃",87,83,82)	
		};
		
		SpecStud [] ssArr = {
				new SpecStud("일호인",83,85,87,82),
                new SpecStud("이호인",53,55,57,50),
                new SpecStud("삼호인",64,63,66,60),
                new SpecStud("사호인",99,90,99,92)	
		};
