...
class MyMyExcep extends Exception{
	...
	void ppp() {
		...
		String [] arr = {
				"는 필수입니다.", "이 일치하지 않습니다.", "유효하지 않는 값입니다."
		};
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			UserQQ [] arr = {
					...
					new UserQQ(data, "pw확인", true, 1),
					new UserQQ(data, "성명", true),
					new UserQQ(data, "생년월일", 19800000),
					new UserQQ(data, "이메일", false),
					new UserQQ(data, "취미", false),
					new UserQQ(data, "특기", false),
					new UserQQ(data, "전화번호", true),
					new UserQQ(data, "핸드폰", false),
					new UserQQ(data, "성별", true)
			};
			try {
