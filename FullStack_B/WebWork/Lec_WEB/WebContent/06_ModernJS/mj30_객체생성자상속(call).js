...
function Dog(name, sound) {
  ...
  // .call(this, 상속하는 부모 객체 생성자 파라미터...)
  // Java 의 [super() 와 같은 기능.... => super 은... react 에서도...]
}
...
console.log(dog.sharedValue); // 100
console.log(cat.sharedValue); // 100

console.log(dog);
// Animal { type: '개', name: '멍멍이', sound: '멍멍' }
console.log(cat);
// Animal { type: '고양이', name: '야옹이', sound: '야옹' }
